<div class="form-container">
    <div>
        <h2 class="title">Inserisci nuovo dipendente</h2>
    </div>
    <form id="save" class="form" action="index.php" method="post" >
        ...
        <div>
            <input id="newClerk"  name="insert" class="submit" type="submit" value="Inserisci">
        </div>
...
<form action="index.php" method="get" class="search">
    <h2>Cerca per nome, cognome, contratto o mansione</h2>
    <input name="text" type="text" placeholder="&#128269">
    <input class="submitsearch" name="search" type="submit" value="Cerca">
</form>
<div class="show-list">
    <h2 class="title">Elenco dipendenti</h2>
<table>
  <tr class='flex'>
    <th>Matricola</th>
    <th>Nome</th>
            ...
            foreach($users as $user){
                ...
                <form action='index.php?id=$user[id]' method='post'>
                    <tr class='flex'>
                        ...
                        <th>
                            <a class='button href='controller/delete.php?delete=$user[id]'><img src='img/delete.png' width='20px'/></a>
                            <button class='button' type='submit' name='update'><img src='../img/refresh.png' width='20px'/></button>
                        </th>
                    </tr>
                </form>
                ";
