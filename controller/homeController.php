<?php
	$message = "";
	$preg_match_str = "/[A-Z0-9]+$/"; //estrapolata in variabile così da poterla riusare quando opportuno
	if(isset($_POST['insert'])){
		...
		if(preg_match($preg_match_str, $_POST['fiscalcode']) && $rookie != ""  && $name != "" && $lastname != "" && $role != "" && $typeContract != ""){
